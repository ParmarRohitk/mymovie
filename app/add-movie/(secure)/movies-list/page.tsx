...
const MoviesList = () => {
    ...
    return (
        <div className="min-h-screen p-6 bg-gradient-to-r from-purple-500 to-indigo-600">
            <div className="flex justify-center mb-4 mt-6 pt-8">
                <input
                    type="text"
                ...
                {sortedMovies.map(movie => (
                    <div key={movie.id} className="bg-white text-black rounded-lg shadow-lg p-4">
                        <h2 className="text-xl font-semibold">
                            {movie.id}  <span className="text-sm">{movie.name}</span>
                        </h2>
